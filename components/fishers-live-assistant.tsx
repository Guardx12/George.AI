...
import { CalendarDays, Loader2, MapPin, Mic, PhoneOff, Ticket, Trees, Volume2 } from "lucide-react"
    ...
    <section className="mx-auto w-full max-w-6xl px-4 pb-16 pt-6 sm:px-6 lg:px-8">
      <div className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
        ...
        <div className="space-y-5">
          <div className="rounded-[30px] border border-[#7ca44d]/25 bg-white p-6 shadow-[0_24px_80px_rgba(39,73,30,0.1)]">
            ...
            <div className="mt-5 grid gap-3">
              <a href="https://fishersfarmpark.visihost.co.uk/" target="_blank" rel="noreferrer" className="inline-flex items-center justify-center gap-2 rounded-2xl bg-[#f6c64b] px-4 py-3 text-sm font-extrabold text-[#5b3c00] transition hover:-translate-y-0.5">
                <Ticket className="h-4 w-4" /> Buy tickets
              </a>
              <a href="https://www.fishersfarmpark.co.uk/holiday-cottages" target="_blank" rel="noreferrer" className="inline-flex items-center justify-center gap-2 rounded-2xl bg-[#2d5a27] px-4 py-3 text-sm font-extrabold text-white transition hover:-translate-y-0.5">
                <Trees className="h-4 w-4" /> Book a stay
              </a>
              <a href="https://www.fishersfarmpark.co.uk/events" target="_blank" rel="noreferrer" className="inline-flex items-center justify-center gap-2 rounded-2xl border border-[#7ca44d]/30 bg-[#f8f5e7] px-4 py-3 text-sm font-extrabold text-[#26461f] transition hover:-translate-y-0.5">
                <CalendarDays className="h-4 w-4" /> See what&apos;s on
              </a>
            </div>
          </div>
